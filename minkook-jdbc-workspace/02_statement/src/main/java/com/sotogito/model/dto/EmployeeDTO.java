package com.sotogito.model.dto;
 ...
 * 3. 유사어 : VO, Bean, Entity
 *
 * ## DTO 클래스 작성
 * 1. 모든 필드는 private
 * 2. 기본생성자 + 모든 필드를 초기화하는 생성자
 * 3. 모든 필드에 대한 getter/setter 필수
 * 4. toString 오버라이딩 => 모든 필드값을 하나의 문자열로 반환 (선택)
 * 5. 직렬화 처리 (선택)
 */
public class EmployeeDTO {
    ...
    public EmployeeDTO(String empId, String empName, String empNo, String email, String phone, String deptCode,
                       ...
                       Date hireDate, Date quitDate, String quitYn) {
        this.empId = empId;
